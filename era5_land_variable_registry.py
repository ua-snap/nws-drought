...
VARIABLE_REGISTRY = {
    ...
    "pev": {
        ...
        "recent_dir": "era5_land_daily_pev",
        "short_name": "pev",
        "daily_op": "sum",
        "suffix": ".grib",
    ...
    "swe": {
        ...
        "recent_dir": "era5_land_daily_swe",
        "short_name": "sd",
        "daily_op": "mean",
        "suffix": ".nc",
    ...
    "swvl1": {
        ...
        "recent_dir": "era5_land_daily_swvl1",
        "short_name": "swvl1",
        "daily_op": "mean",
        "suffix": ".nc",
    ...
    "swvl2": {
        ...
        "recent_dir": "era5_land_daily_swvl2",
        "short_name": "swvl2",
        "daily_op": "mean",
        "suffix": ".nc",
